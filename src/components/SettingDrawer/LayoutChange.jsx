...
export default {
  ...
  render (h) {
    ...
    const { contentWidth, fixedHeader, layout, fixSiderbar, splitMenu } = this
    ...
    return (
      <List
        ...
        dataSource={[
          ...
          {
            title: i18n('app.setting.splitMenu'),
            disabled: layout === 'topmenu',
            disabledReason: i18n('app.setting.fixedsidebar.hint'),
            action: (
              <Switch
                ...
                disabled={layout === 'topmenu'}
                checked={!!splitMenu}
                onChange={(checked) => handleChange('splitMenu', checked)}
              />
            )
          }
        ]}
