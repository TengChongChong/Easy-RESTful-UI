...
export const preferenceSetting = {
    ...
    list: {
        // 一般不会被搜索的字段
        excludeSearch: ['id', 'pIds', 'tips', 'createUser', 'createDate', 'content', 'abstract', 'orderNo', 'describe', 'icon', 'version'],
        // 一般不显示以下字段
        exclude: ['id', 'pId', 'pIds', 'tips', 'createUser', 'createDate', 'content', 'abstract', 'describe', 'version'],
        // 默认匹配方式
        matching: {
            // 一般使用 = 匹配的字段
    ...
    input: {
        // 一般不填写以下字段
        exclude: ['id', 'createUser', 'createDate', 'editUser', 'editDate', 'version', 'pIds'],
        // 以下为各种类型输入框对应的常用字段名
        type: {
